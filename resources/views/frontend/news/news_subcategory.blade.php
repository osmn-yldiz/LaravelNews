        ...
        <div class="row">
            <div class="col-lg-8 col-md-8">
                <div class="rachive-info-cats">
                    <a href="{{ url('/') }}"><i class="las la-home"></i> </a> <i
                        class="las la-chevron-right"></i> {{ $breadsubcat->subcategory_name }}
                </div>
                <div class="row">
                            ...
                            <div class="col-lg-8 col-md-8">
                                <div class="archive-shadow arch_margin">
                                    ...
                                    <div class="archive1-padding">
                                        ...
                                        <div
                                            class="content-details">{!! \Illuminate\Support\Str::limit($item->news_details, 100) !!}
                                ...
                                @foreach($newnewspost as $key => $item)
                                    <div class="archive-tabWrpp archiveTab-border">
                                        <div class="archiveTab-image ">
                                            <a href="{{ url('news/details/'.$item->id.'/'.$item->news_title_slug) }}"><img
                                                    class="lazyload" src="{{ asset($item->image) }}"></a></div>
                                        <a href="{{ url('news/details/'.$item->id.'/'.$item->news_title_slug) }}"
