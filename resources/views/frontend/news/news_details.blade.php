            ...
            <div class="col-lg-8 col-md-8">
                ...
                <div class="row g-2">
                    ...
                    <div class="col-lg-11 col-md-10">
                        <div class="reportar-title">
                            Posted By <a
                                href="{{ route('reporter.news', $news->user_id) }}">{{ $news->user->name }}</a>
                        </div>
                ...
                @guest
                    <p><b> For Add Product Review. You Need To Login First <a href="{{ route('login') }}"> Login
                                Page </a></b></p>
                @else
                    <form action="{{ route('review.store') }}" method="post" class="wpcf7-form init"
                                ...
                                @foreach($newnewspost as $key => $newsitem)
                                    <div class="archive-tabWrpp archiveTab-border">
                                        ...
                                        <h4 class="archiveTab_hadding"><a
                                                href="{{ url('news/details/'.$newsitem->id.'/'.$newsitem->news_title_slug) }}">{{ $newsitem->news_title }}</a>
                                        </h4>
