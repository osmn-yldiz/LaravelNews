                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <select class="form-select changeLang">
                            ...
                            <option value="tr" {{ session()->get('locale') == 'tr' ? 'selected' : '' }}>Turkey</option>
                        </select>
                    </div>
                </div>
                    ...
                    <ul id="menu-main-menu" class="menu">
                        ...
                        @foreach($categories as $category)
                            <li id="menu-item-291"
                                ...
                                <a href="{{ url('news/category/'.$category->id.'/'.$category->category_slug) }}">{{ \Stichoza\GoogleTranslate\GoogleTranslate::trans($category->category_name, app()->getLocale()) }}</a>
                                ...
                                <ul class="sub-menu">
                                    @foreach($subcategories as $subcategory)
                                        <li id="menu-item-294"
                                            ...
                                            <a href="{{ url('news/subcategory/'.$subcategory->id.'/'.$subcategory->subcategory_slug) }}">{{ \Stichoza\GoogleTranslate\GoogleTranslate::trans($subcategory->subcategory_name, app()->getLocale()) }}</a>
                                        </li>
                                    @endforeach
                                </ul>
