                ...
                <div class="row">
                    <div class="col-md-12 top_scroll2">
                                ...
                                @foreach($breaking_news as $item)
                                    <a href="{{ url('news/details/'.$item->id.'/'.$item->news_title_slug) }}">
                                        <img src="{{ asset('frontend/assets/images/favicon.gif') }}" alt="Logo"
                                             title="Logo" width="30px"
                                             height="auto">
                                        {{ \Stichoza\GoogleTranslate\GoogleTranslate::trans($item->news_title, app()->getLocale()) }}
                                    </a>
                                @endforeach
                        ...
                        <div class="scroolbar5">
                            <button data-bs-dismiss="alert" aria-label="Close"><span aria-hidden="true">×</span>
                            </button>
                        </div>
                    </div>
                </div>
