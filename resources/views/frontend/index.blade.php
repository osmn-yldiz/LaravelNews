...
@section('title', 'Easy Online News')
...
@section('content')
                ...
                <div class="col-lg-9 col-md-8">
                    <div class="row">
                        <div class="col-lg-7 col-md-7">
                            <div class="themesbazar_led_active owl-carousel owl-loaded owl-drag">
                                ...
                                @php
                                    $news_slider = \App\Models\NewsPost::where('status', 1)->where('top_slider', 1)->latest()->limit(3)->get();
                                @endphp
                                            ...
                                            <div class="owl-item" style="width: 506.25px; margin-right: 20px;">
                                                <div class="secOne_newsContent">
                                                    <div class="sec-one-image">
                                                        <a href="{{ url('news/details/'.$slider->id.'/'.$slider->news_title_slug) }}"><img
                                                                class="lazyload"
                                                        ...
                                                        <h1 class="sec-one-title">
                                                            <a href="{{ url('news/details/'.$slider->id.'/'.$slider->news_title_slug) }}">{{ \Stichoza\GoogleTranslate\GoogleTranslate::trans($slider->news_title, app()->getLocale()) }}</a>
                                                        </h1>
                                                    </div>
                                                </div>
                                            </div>
                        ...
                        <div class="col-lg-5 col-md-5">
                            ...
                            @php
                                $section_three = \App\Models\NewsPost::where('status', 1)->where('first_section_three', 1)->inRandomOrder()->take(3)->get();
                            @endphp
                                ...
                                <div class="secOne-smallItem">
                                    <div class="secOne-smallImg">
                                        ...
                                        <h5 class="secOne_smallTitle">
                                            <a href="{{ url('news/details/'.$three->id.'/'.$three->news_title_slug) }}">{{ \Stichoza\GoogleTranslate\GoogleTranslate::trans($three->news_title, app()->getLocale()) }}</a>
                                        </h5>
                                    </div>
                                </div>
                            @endforeach
                    ...
                    <div class="sec-one-item2">
                        <div class="row">
                            ...
                            @php
                                $section_nine = \App\Models\NewsPost::where('status', 1)->where('first_section_nine', 1)->inRandomOrder()->take(9)->get();
                            @endphp
                                    ...
                                    <div class="sec-one-wrpp2">
                                        <div class="secOne-news">
                                            <div class="secOne-image2">
                                                <a href="{{ url('news/details/'.$nine->id.'/'.$nine->news_title_slug) }}"><img
                                                        class="lazyload" src="{{ asset($nine->image) }}"></a>
                                            </div>
                                            <h4 class="secOne-title2">
                                                <a href="{{ url('news/details/'.$nine->id. '/'. $nine->news_title_slug) }}">{{ \Stichoza\GoogleTranslate\GoogleTranslate::trans($nine->news_title, app()->getLocale()) }}</a>
                                            </h4>
                                        </div>
                                        <div class="cat-meta">
                                            <a href="javascript:void(0);"> <i class="lar la-newspaper"></i>
                ...
                <div class="col-lg-3 col-md-4">
                    <div class="live-item">
                        <div class="live_title">
                            <a href="{{ $live->live_url }}">LIVE TV </a>
                            <div class="themesBazar"></div>
                        </div>
                        <div class="popup-wrpp">
                            <div class="live_image">
                                <img width="700" height="400" src="{{ asset($live->live_image) }}"
                                     class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="Live Tv"
                                     loading="lazy">
                    ...
                    <div class="tab-content" id="pills-tabContent">
                        <div class="tab-pane active show  fade" id="recent" role="tabpanel"
                            ...
                            <div class="news-titletab">
                                ...
                                @foreach($newnewspost as $newsitem)
                                    <div class="tab-image tab-border">
                                        ...
                                        <h4 class="tab_hadding"><a
                                                href="{{ url('news/details/'.$newsitem->id.'/'.$newsitem->news_title_slug) }}">{{ \Illuminate\Support\Str::words(\Stichoza\GoogleTranslate\GoogleTranslate::trans($newsitem->news_title, app()->getLocale()), 5) }}</a>
                                        </h4>
                                    </div>
                                @endforeach
                        ...
                        <div class="tab-pane fade" id="popular" role="tabpanel" aria-labelledby="popular">
                            <div class="news-titletab">
                                ...
                                @foreach($newspopular as $newsitem)
                                    <div class="tab-image tab-border">
                                        <a href="{{ url('news/details/'.$newsitem->id.'/'.$newsitem->news_title_slug) }}"><img
                                                class="lazyload" src="{{ asset($newsitem->image) }}"></a>
                                        <a href="{{ url('news/details/'.$newsitem->id.'/'.$newsitem->news_title_slug) }}"
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6 col-md-6">
                <div class="themesBazar_widget">
                    <div class="textwidget"><p><img loading="lazy" class="aligncenter size-full wp-image-74"
                ...
                <div class="col-lg-8 col-md-8">
                    ...
                    <h2 class="themesBazar_cat07"><a
                            href="{{ url('news/category/'.$skip_cat_0->id.'/'.$skip_cat_0->category_slug) }}"> <i
                                class="las la-align-justify"></i> {{ $skip_cat_0->category_name }} </a>
                    </h2>
                ...
                <div class="col-lg-12 col-md-12">
                    ...
                    <h2 class="themesBazar_cat04"><a
                            href="{{ url('news/category/'.$skip_cat_2->id.'/'.$skip_cat_2->category_slug) }}"> <i
                                class="las la-align-justify"></i> {{ $skip_cat_2->category_name }} </a>
                    </h2>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-4">
                    ...
                    <h2 class="themesBazar_cat01"><a
                            href="{{ url('news/category/'.$skip_cat_1->id.'/'.$skip_cat_0->category_slug) }}"> {{ $skip_cat_1->category_name }} </a>
                        <span> <a href="{{ url('news/category/'.$skip_cat_1->id.'/'.$skip_cat_0->category_slug) }}"> More <i
    ...
    <section class="section-seven">
        <div class="container">
            ...
            <h2 class="themesBazar_cat01"><a
                    href="{{ url('news/category/'.$skip_cat_4->id.'/'.$skip_cat_4->category_slug) }}"> {{ $skip_cat_4->category_name }} </a>
                <span> <a href="{{ url('news/category/'.$skip_cat_4->id.'/'.$skip_cat_4->category_slug) }}"> More <i
                            class="las la-arrow-circle-right"></i> </a></span></h2>
                            ...
                            <div class="col-lg-5 col-md-5">
                                <div class="black-bg">
                                    <div class="secSeven-image">
                                        <a href="{{ url('news/details/'.$item->id.'/'.$item->news_title_slug) }}"><img
                                                class="lazyload" src="{{ asset($item->image) }}"></a> <a
