                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form id="myForm" method="post" action="{{ route('admin.newsPost.update', $newspost->id) }}"
                                    ...
                                    <div class="form-group col-md-6 mb-3">
                                        ...
                                        <select class="form-select" name="category_id">
                                            ...
                                            @foreach($categories as $category)
                                                <option
                                                    value="{{ $category->id }}" {{ $category->id == $newspost->category_id ? 'selected' : '' }}>{{ $category->category_name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="form-group col-md-6 mb-3">
                                        ...
                                        <select class="form-select" name="subcategory_id">
                                            ...
                                            @else
                                                ...
                                                @foreach($subcategories as $subcategory)
                                                    <option
                                                        value="{{ $subcategory->id }}" {{ $subcategory->id == $newspost->subcategory_id ? 'selected' : '' }}>{{ $subcategory->subcategory_name }}</option>
                                                @endforeach
                                            @endif
                                        </select>
                                    </div>
                                    <div class="form-group col-md-6 mb-3">
                                        ...
                                        <select class="form-select" id="example-select" name="user_id">
                                            ...
                                            @foreach($adminuser as $user)
                                                <option
                                                    value="{{ $user->id }}" {{ $user->id == $newspost->user_id ? 'selected' : '' }}>{{ $user->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="form-group col-md-6 mb-3">
