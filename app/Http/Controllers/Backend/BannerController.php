...
class BannerController extends Controller
{
    ...
    public function Update($id, Request $request)
    {
        ...
        if ($request->file('home_one')) {
            ...
            $notification = array(
                'message' => 'Home banner one updated successfully!',
                'alert-type' => 'success',
            );
        ...
        if ($request->file('home_two')) {
            ...
            $notification = array(
                'message' => 'Home banner two updated successfully!',
                'alert-type' => 'success',
            );
            return redirect()->back()->with($notification);
        } // End If
        ...
        if ($request->file('home_three')) {
            ...
            $notification = array(
                'message' => 'Home banner three updated successfully!',
                'alert-type' => 'success',
            );
            return redirect()->back()->with($notification);
        } // End If
        ...
        if ($request->file('home_four')) {
            ...
            $notification = array(
                'message' => 'Home banner four updated successfully!',
                'alert-type' => 'success',
            );
            return redirect()->back()->with($notification);
        } // End If
        ...
        if ($request->file('news_category_one')) {
            ...
            $notification = array(
                'message' => 'News category one updated successfully!',
                'alert-type' => 'success',
            );
            return redirect()->back()->with($notification);
        } // End If
        ...
        if ($request->file('news_details_one')) {
            ...
            $notification = array(
                'message' => 'News details one updated successfully!',
                'alert-type' => 'success',
            );
            return redirect()->back()->with($notification);
        } // End If
