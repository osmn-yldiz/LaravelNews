...
class IndexController extends Controller
{
    ...
    public function NewsDetails($id, $slug)
    {
        ...
        $relatedNews = NewsPost::where('category_id', $cat_id)->where('id', '!=', $id)->orderBy('id', 'DESC')->inRandomOrder()->limit(6)->get();
    ...
    public function CatWiseNews($id, $slug)
    {
        ...
        return view('frontend.news.news_category', compact('news', 'breadcat', 'newstwo', 'newnewspost', 'newspopular'));
    } // End Method
    ...
    public function SubCatWiseNews($id, $slug)
    {
        ...
        return view('frontend.news.news_subcategory', compact('news', 'breadsubcat', 'newstwo', 'newnewspost', 'newspopular'));
    } // End Method
    ...
    public function NewsSearch(Request $request)
    {
        ...
        $newnewspost = NewsPost::orderBy('id', 'DESC')->limit(8)->get();
        $newspopular = NewsPost::where('view_count', 'DESC')->limit(8)->get();
        return view('frontend.news.news_search', compact('item', 'news', 'newnewspost', 'newspopular'));
    } // End Method
    ...
    public function ReporterNews($id)
    {
        ...
        return view('frontend.reporter.reporter_news', compact('reporter', 'news'));
    } // End Method
}
